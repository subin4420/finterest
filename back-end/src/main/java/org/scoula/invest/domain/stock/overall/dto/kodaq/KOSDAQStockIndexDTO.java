package org.scoula.invest.domain.stock.overall.dto.kodaq;

import lombok.AllArgsConstructor;
import lombok.Builder;
import lombok.Data;
import lombok.NoArgsConstructor;
import org.scoula.invest.domain.stock.overall.domain.kosdaq.KOSDAQStockIndexVO;
@Data
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class KOSDAQStockIndexDTO {
    private Long id;
    ...
    // VO -> DTO 변환
    public static KOSDAQStockIndexDTO of(KOSDAQStockIndexVO vo) {
        return vo == null ? null : KOSDAQStockIndexDTO.builder()
                .id(vo.getId())
                .basDt(vo.getBasDt())
                .idxNm(vo.getIdxNm())
                .idxCsf(vo.getIdxCsf())
    ...
    // DTO -> VO 변환
    public KOSDAQStockIndexVO toVo() {
        return KOSDAQStockIndexVO.builder()
                .id(id)
                .basDt(basDt)
                .idxNm(idxNm)
                .idxCsf(idxCsf)
